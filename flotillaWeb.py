...
# Creates a web-page interface for FlotillaBorg
...
flippedMotors = True			# Are the motors mounted so that they have to move in opposite directions to drive the bot forwards
...
FB = flotillaBorg.FlotillaBorg()

FB.Init(flippedMotors)
...
class WebServer(SocketServer.BaseRequestHandler):
    def handle(self):
        ...
        if getPath.startswith('/cam.jpg'):
            ...
            #driveLeft *= maxPower
            #driveRight *= maxPower
            FB.setMotor1(driveRight)
            FB.setMotor2(driveLeft)
...
try:
    ...
    FB.finish()
    print 'Finished/Terminated the FlotillaBorg'
